...
hero:
  image:
    ...
    alt: 墨絵風の風景。旅人が細道を歩き、書に「セルフホスティングの細道」とある
---

import { Card, CardGrid } from '@astrojs/starlight/components';
import IconLinkCard from '../../components/IconLinkCard.astro';

## VPS・Docker・Coolifyで始めるセルフホスティング
...
- Docker や Coolify など、セルフホスティングの標準的なツールを制限なく導入できる
...
<CardGrid stagger>
	...
	<IconLinkCard
		title="ブログサイト"
		icon="open-book"
		href="/guides/wordpress/installation/"
		description="まずは <strong>WordPress</strong> でブログを立ち上げ、Coolify の基本操作（デプロイ、ドメイン、SSL）を学びます。"
	/>
	<Card title="写真バックアップ（Coming soon）" icon="seti:image">
		**Immich** で写真・動画のバックアップを立ち上げ、ストレージとデータの扱いを学びます。
	</Card>
	<Card title="ファイル共有（Coming soon）" icon="laptop">
